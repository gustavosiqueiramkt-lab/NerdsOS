...
const sheetVariants = cva(
  'fixed z-40 gap-4 bg-[var(--color-card)] border-[var(--color-border)] shadow-2xl shadow-black/50 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
